...
class EEGProcessor:
    ...
    def extract_features(self, eeg_data):
        ...
        n_features_per_channel = len(feature_funcs) + n_bands * 2  # Basic features + band power + band entropy
        ...
        for trial in range(n_trials):
            ...
            for channel in range(n_channels):
                ...
                for band_name, (low_freq, high_freq) in FREQ_BANDS.items():
                    ...
                    # Calculate band entropy
                    band_entropy = ant.spectral_entropy(band_data, sf=SAMPLE_RATE, method='welch', normalize=True)
                    features[trial, feature_idx] = band_entropy
                    feature_idx += 1
