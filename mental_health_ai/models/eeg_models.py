...
class EEG1DCNN(nn.Module):
    ...
    def __init__(self, input_dim, num_channels=32, num_classes=1, dropout_rate=0.5):
        """
        ...
        self.feature_size = 128 * (input_dim // 8)
...
class EEG1DCNNGRU(nn.Module):
    ...
    def __init__(self, input_dim, num_channels=32, hidden_dim=128, num_classes=1, dropout_rate=0.5):
        """
        ...
        Args:
            ...
            dropout_rate (float): Dropout rate for regularization
        """
        super(EEG1DCNNGRU, self).__init__()
...
class EEGTransformer(nn.Module):
    ...
    def __init__(self, input_dim, num_channels=32, d_model=128, nhead=8, 
                 num_layers=4, dim_feedforward=512, num_classes=1, dropout_rate=0.1):
        """
